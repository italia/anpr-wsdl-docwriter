...
<!--
* ====================================================================
* italia-wsdl-viewer.xsl
* Version: 1.0
*
* Author: PDP FSUG
* Original Author: tomi vanek
* Website: pdp.linux.it
* ====================================================================
-->
...
-->
   ...
   <xsl:template name="about.detail">
      <xsl:param name="version"/>
        <div>
            <b>Author</b>: <a href="http://pdp.linux.it/" target="_blank">PDP FSUG</a><br></br>
            <b>Original author</b>: <a href="http://tomi.vanek.sk/" target="_blank">Tomi Vanek</a>
      </div>
   </xsl:template>
...
<xsl:template name="footer.render">
    <div id="footer">
        <p>Made with ❤ and Free Software by PDP FSUG Team in <a href="https://www.openstreetmap.org/relation/42382/history" target="_blank">Fabriano</a></p>
    </div>
</xsl:template>
